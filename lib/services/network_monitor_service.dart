...
class NetworkMonitorService {
  ...
  static Future<List<NetworkConnection>> getCurrentConnections() async {
    // In production, read from /proc/net/tcp via MethodChannel
    // For demo, return realistic simulated connections
  ...
  static List<NetworkConnection> _simulatedConnections() {
    final baseConns = [
      ...
      ('31.13.86.36', 'edge-star-mini-shv-01-mia3.facebook.com', 443, 'HTTPS', 'United States', 'US', 'Meta Platforms', true, 89.0),
      ...
      ('193.32.83.12', '', 8080, 'HTTP', 'Netherlands', 'NL', 'Hosting Services', false, 44.0),
    ...
    return baseConns.asMap().entries.map((entry) {
      ...
      // Add some random noise to traffic
